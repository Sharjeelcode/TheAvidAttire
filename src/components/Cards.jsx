    ...
    >
      ...
      >
        <img
          ...
          alt="Card"
          className="w-full h-full object-cover cursor-pointer animate__animated  animate__pulse "
        />
        {cardHover && (
      ...
      <div className="flex justify-center flex-col items-center cursor-pointer animate__animated animate__headShake  ">
